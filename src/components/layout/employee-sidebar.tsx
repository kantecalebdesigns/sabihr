      ...
      <div className="shrink-0 border-t-2 border-slate-200">
        {!collapsed ? (
          <div className="px-4 py-3">
            <div className="flex items-center gap-3 rounded-lg p-2 hover:bg-slate-50 transition-colors cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm">
                <span className="text-[11px] font-semibold text-white">AO</span>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[13px] font-medium text-slate-900 truncate">Adebayo Ogunlesi</p>
                <p className="text-[11px] text-slate-400 truncate">Sr. Software Engineer</p>
              </div>
          ...
          <div className="flex flex-col items-center py-3 gap-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm">
              <span className="text-[10px] font-semibold text-white">AO</span>
            </div>
          </div>
        )}

...
export function RedeploymentForm({ open, onClose, inline }: RedeploymentFormProps) {
  ...
  const successContent = (
    <div className="flex flex-col items-center text-center py-6 space-y-3">
      ...
      <Button onClick={inline ? handleReset : handleClose} className="mt-2">
  ...
  const formContent = (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-2 pt-2">
        ...
        <Button type="submit" disabled={isSubmitting} className={inline ? "w-full" : ""}>
          {isSubmitting ? (
  ...
  if (inline) {
    return (
      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-medium">Request Redeployment</CardTitle>
        </CardHeader>
        <CardContent>
